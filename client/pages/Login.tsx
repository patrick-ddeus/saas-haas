...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black to-indigo-100 flex items-center justify-center p-4">
    ...
    <div className="text-center mb-8">
      <div className="flex items-center justify-center gap-4 mb-4">
        ...
        <div className="text-left">
          <h1 className="text-3xl font-bold text-white">HABEAS DESK</h1>
